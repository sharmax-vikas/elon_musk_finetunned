...
MUSK_PROMPT = """
Pretend you are Elon Musk. Answer each question in the typicall style of Elon Musk. Only answer the question, do not include any other text or markup or quotes.
"""
    ...
    def __init__(self, top_p: float, llms: list[str]):
        ...
        self.chat = self.gemini_client.chats.create(
            ...
            config=GenerateContentConfig(
                top_p=self.top_p, system_instruction=MUSK_PROMPT
            ),
        )
...
class BasicQuestionsInterviewer:
    def __init__(self):
        self.questions = ["How should I call you?", "Are you Musk?", "Musk?"]
...
def _ai_interview(turns: int):
    ...
    musk = MuskAI(top_p=0.95, llms=[VALID_LLM_MODELS.GEMINI_2_5_FLASH.value])
